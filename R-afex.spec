...
Source0  : https://cran.r-project.org/src/contrib/afex_0.21-2.tar.gz
...
%description
ANOVA or mixed models. aov_ez(), aov_car(), and aov_4() allow
         specification of between, within (i.e., repeated-measures), or mixed
         between-within (i.e., split-plot) ANOVAs for data in long format (i.e.,
         one observation per row), aggregating multiple observations per
         individual and cell of the design. mixed() fits mixed models using
...
export LANG=C
export SOURCE_DATE_EPOCH=1530307506
...
/usr/lib64/R/library/afex/data/fhch2010.rda
/usr/lib64/R/library/afex/data/ks2013.3.rda
/usr/lib64/R/library/afex/data/md_12.1.rda
/usr/lib64/R/library/afex/data/md_15.1.rda
/usr/lib64/R/library/afex/data/md_16.1.rda
/usr/lib64/R/library/afex/data/md_16.4.rda
/usr/lib64/R/library/afex/data/obk.long.rda
/usr/lib64/R/library/afex/data/sk2011.1.rda
/usr/lib64/R/library/afex/data/sk2011.2.rda
